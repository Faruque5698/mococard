                    ...
                    <table class="table align-items-center table-light">
                        ...
                        @forelse($methods as $method)
                            <tr>
                                <td scope="row">
                                    <div class="media align-items-center">
                                        <a href="{{ route('admin.withdraw.method.edit', $method->id) }}" class="avatar avatar-sm rounded-circle mr-3">
                                            <img style="width: 100px; height: 100px" src="{{ get_image(config('constants.withdraw.method.path') .'/'. $method->image) }}" alt="image">
                                        </a>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="{{ route('admin.withdraw.method.update', $method->id) }}"><i class="fa fa-edit"></i></a>
                                    @if($method->status == 1)
