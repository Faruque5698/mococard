                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group has_append">
                                                ...
                                                <input type="text" class="form-control" placeholder="0" name="rate" value="{{ $method->rate }}"/>
                                        ...
                                        <div class="card outline-primary">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="min_limit" placeholder="0" value="{{ $method->min_limit }}" />
                                                </div>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="max_limit" value="{{ $method->max_limit }}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card outline-dark">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="fixed_charge" value="{{ $method->fixed_charge }}"/>
                                                </div>
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="percent_charge" value="{{ $method->percent_charge }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
