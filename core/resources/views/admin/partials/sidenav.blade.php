...
{{--                </li>--}}
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.virtual-card*',3)}}">
                        <i class="menu-icon las la-credit-card"></i>
                        <span class="menu-title">Virtual Cards</span>

                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.virtual-card*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.virtual-card.cards')}} ">
                                <a href="{{route('admin.virtualCard')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">Cards</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.virtual-card.transactions')}} ">
                                <a href="{{route('admin.allVirtualCardTransaction')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">Transactions</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.virtual-card.plan')}} ">
                                <a href="{{route('admin.virtualCard.plan')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.withdraw*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.withdraw.method.methods')}} ">
                                <a href="{{route('admin.withdraw.method.methods')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.withdraw.pending')}} ">
                                <a href="{{route('admin.withdraw.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Withdraw')</span>
                                    @if($pending_deposits_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_deposits_count}}</span>
                                    @endif
                                </a>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.withdraw.approved')}} ">
                                <a href="{{route('admin.withdraw.approved')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Withdraw')</span>
                                </a>
                            </li>
...
{{--                                <a href="{{route('admin.deposit.successful')}}" class="nav-link">--}}
{{--                                    <i class="menu-icon las la-dot-circle"></i>--}}
{{--                                    <span class="menu-title">@lang('Rejected Withdraw')</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.withdraw.log')}} ">
                                <a href="{{route('admin.withdraw.log')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Withdraw')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.setting.app')}}">
                    <a href="{{route('admin.setting.app')}}" class="nav-link">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.frontend*',3)}}">
                        ...
                        <span class="menu-title">@lang('FrontEnd Setting')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.frontend*',2)}} ">
                        <ul>

                            <li class="sidebar-menu-item {{menuActive('admin.frontend.banner')}} ">
                                <a href="{{route('admin.frontend.banner')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banner')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive(['admin.frontend.brand'])}} ">
                                <a href="{{ route('admin.frontend.brand') }}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Brand Setting')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.frontend.about')}} ">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.add_card_to_main_account_charge')}}">
                    <a href="{{route('admin.add_card_to_main_account_charge')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">@lang('Cash transfer charge')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.referral')}}">
                    <a href="{{route('admin.referral')}}" class="nav-link">
                        ...
                        <span class="menu-title">@lang('Referral settings')</span>
                    </a>
                </li>
...
{{--                <li class="sidebar-menu-item sidebar-dropdown">--}}
{{--                    <a href="javascript:void(0)" class="{{menuActive('admin.cardApi.template*',3)}}">--}}
{{--                        <i class="menu-icon la la-envelope-o"></i>--}}
{{--                        <span class="menu-title">Card API</span>--}}
{{--                    </a>--}}
{{--                    <div class="sidebar-submenu {{menuActive('admin.cardApi.template*',2)}} ">--}}
{{--                        <ul>--}}

{{--                            <li class="sidebar-menu-item {{menuActive('admin.cardApi.template.settings')}} ">--}}
{{--                                <a href="{{route('admin.cardApi.template.setting')}}" class="nav-link">--}}
{{--                                    <i class="menu-icon las la-dot-circle"></i>--}}
{{--                                    <span class="menu-title">Card API Settings</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
