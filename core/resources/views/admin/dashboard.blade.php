    ...
    <div class="row mb-none-30">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--cyan b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $total_sold_card }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">Total Card Sold</span>
                    </div>
                    <a href="{{route('admin.virtualCard')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--pink b-radius--10 box-shadow ">
                ...
                <div class="details" style="padding: 22px 0">
                    <div class="numbers">
                        <span class="amount">{{__($general->cur_sym)}}{{$balance}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">My API Balance</span>
                    </div>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
