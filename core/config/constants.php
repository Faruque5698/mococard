...
return [
    ...
    'kyc' => [
        'front' => [
            'path' => 'assets/images/user/kyc/front',
            'size' => '800x800',
        ],
        'back' => [
            'path' => 'assets/images/user/kyc/back',
            'size' => '800x800',
        ],
    ],
    'admin' => [
    ...
    'frontend' => [
        ...
        'howitwork' => [
            'path' => 'assets/images/frontend/howitwork',
            'size' => '800x600',
        ],
        'whychoose' => [
            'path' => 'assets/images/frontend/whychoose',
            'size' => '60x60',
        ],
        'developer' => [
        ...
        'team' => [
            'path' => 'assets/images/frontend/team',
            'size' => '450x450',
        ]
