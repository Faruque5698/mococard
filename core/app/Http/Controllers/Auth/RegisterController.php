...
//        }
        ...
        $refer = RefferBonus::where('refer_by_id','=',$data['refer_by'])->first();
        if ($refer){
            //        $refer->refer_by_id = $data['refer_by'];
//        $refer->new_user_id = $user->id;
            $refer->refer_bonus = $refer->refer_bonus + $bonus->refer_by_bonus;
            $refer->save();
        }else{
...
//        return "Welcome Now u can login into the mobile app";
    }
