...
class GeneralSettingController extends Controller
{
    public function app(){
        ...
        return view('admin.setting.app', compact('pageTitle', 'general','timezones'));
    }

    public function app_update(Request $request){
        $app = GeneralSetting::find(1);
        $app->playstore_link = $request->playstore_link;
        $app->applestore_link = $request->applestore_link;
        $app->save();
        $notify[] = ['success', 'App setting has been updated.'];
